            ...
            <div className={"flex flex-col"}>
                ...
                <div className={"flex flex-row justify-between items-center pt-5 px-20"}>
                    <div className={"flex flex-row justify-left items-center"}>
                        <div className={"background-color-lighter mr-1 px-2 rounded-md hover:cursor-pointer"}>Truyện
                            đang đọc
                        </div>
                        <div className={"background-color-lighter px-2 rounded-md hover:cursor-pointer"}>Truyện đánh
                            dấu
                        </div>
            ...
            <div>
                <div className={"flex w-[120[x] gap-x-2 items-center"}>
                    ...
                    <div className={"flex items-center text-sm mx-2 p-1 border-1 hover:border-yellow-500 rounded-md"}>
                        <input type={"text"} className={"w-[40px] focus:outline-none px-1"}/>
