...
//     useEffect(() => {
//         const userId = user?.userId || ""; // Use user ID from the store or fallback
//         console.log("Fetching reports for userId:", userId, "role:", role, "page:", page);
//         const fetchReports = async () => {
//             try {
//                 const response = await getAllReports(userId, role, page);
