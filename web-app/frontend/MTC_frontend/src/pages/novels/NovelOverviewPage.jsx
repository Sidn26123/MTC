            ...
            <div className={"px-20"}>
                ...
                <div id = "tab-header">
                    <div className={"flex justify-center secondary-bg text-gray-600"}>
                        <div onClick={() => setMode("rating")}
                            className={"inline-flex items-center py-2 px-3 text-xs space-x-2 border-x primary-bg text-white hover:cursor-pointer"}>
                            <span>ĐÁNH GIÁ</span>
                            <span
                                className={"bg-red-700 inline-flex items-center justify-center min-w-6 h-6 ms-2 px-2 text-xs font-semibold text-white rounded-full"}>10</span>
                        </div>
                        <div onClick={() => setMode("comment")}
                            className={"inline-flex items-center py-2 px-3 text-xs space-x-2 border-x  text-white hover:cursor-pointer"}>
                            <span>BÌNH LUẬN</span>
                            <span
                                className={"bg-red-700 inline-flex items-center justify-center min-w-6 h-6 ms-2 px-2 text-xs font-semibold text-white rounded-full"}>10</span>
                        </div>
...
function NovelStat() {
    const data = {
        image: {
            src: "https://static.cdnno.com/poster/cuu-tinh-ba-the-quyet/300.jpg?1634010296",
            alt: "Cửu Tinh Bá Thể Quyết"
        },
            ...
            <div>
                    ...
                    <div className={"flex flex-col"}>
                        ...
                        <div className={"mb-6 text-gray-500 text-sm mt-1"}>
                            <a className={"text-gray-500"} title="Binh Pham Ma Thuat Su"
                               href="/tac-gia/binh-pham-ma-thuat-su">
                                Binh Pham Ma Thuat Su
                            </a>
                        </div>
                        <div className={"flex flex-row my-3 text-sm"}>
                            <div
                                ...
                                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                                     ...
                                     style={{width: "20px", height: "30px", fill: "gray"}} xml:space="preserve"
                                     className={"mr-2"}
                                >
                                    <g>
                        ...
                        <div className={"flex flex-row leading-10 md:leading-normal space-x-4 hover:cursor-pointer"}>
                            <a className="inline-flex border border-yellow-400 rounded px-2 py-1 ">
                                <span className={"text-xs text-yellow-400"}>Còn tiếp</span>
                            </a>
                ...
                <div className={"pb-3"}>
                    <div className={"flex justify-between items-center secondary-bg text-gray-600"}>
                        ...
                        <div
                            className="flex items-center space-x-1 text-gray-800 pr-3 hover:cursor-pointer">
                ...
                <div>
                    <div className={"secondary-bg text-gray-600 p-4 rounded text-sm"}>
                        ...
                        "Đọc truyện online miễn phí, nhanh nhất tại MTC"
                        <br/>
                ...
                <div className={"pb-3 pt-3"}>
                    <div className={"flex justify-between items-center secondary-bg text-gray-600"}>
                        <h2 className="inline-flex items-center py-2 px-3 text-xs">CÙNG ĐĂNG BỞI</h2>

                    </div>
                    <div className={"flex flex-row justify-start items-center mt-2"}>
                        <div className={"w-44 h-60 mr-2 mb-2"}>
                            <MinialIntroduceNovelCard data = {data}/>
...
function NovelRating(){
    return (
        <>
            <div>
                <div className={"grid grid-cols-4 gap-y-6 md:gap-y-0 md:gap-x-4 mt-6 mx-2"}>
                    <div className={"col-span-4 md:col-span-4 space-y-6"}>
                        <div
                            className={"py-4 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-black dark:border-gray-700 space-y-6"}>
                            <div className={"space-y-6 p-2"}>
                                <div className={"flex flex-col space-y-2 w-full"}>
                                    <h3>
                                        "Chấm điểm nội dung truyện: "
                                        <span className={"font-bold primary-text-color"}>5</span>
                                        " điểm"
                                    </h3>
                                    <div className={"w-full"}>
                                        <input type="range" min="1" max="5" value="5" step={0.1} className={"slider"}/>
                                    </div>
                                </div>
                            </div>
                            <div className={"space-y-6 p-2"}>
                                <div className={"flex items-center"}>
                                    ...
                                    <span className={"ml-3 text-sm space-x-1"}>
                                    <span className={"font-medium text-gray-500"}>
                                        Ti chi muon cham diem
                                    </span>
                                ...
                                <div className="space-y-4">
                                    <input data-x-model="character" type="text"
                                           className="px-3 w-full text-sm text-gray-900 border-1 p-2 border-gray-600 focus:ring-0 focus:outline-none dark:text-white placeholder-gray-400"
                                           placeholder="Nhân vật chính như nào? (nhiệt huyết?, vô sỉ?, thông minh? ...)"/>
                                    <input
                                        data-x-model="story" type="text"
                                        className="px-3 w-full text-sm text-gray-900 border-1 p-2 focus:ring-0 border-gray-600  focus:outline-none dark:text-white placeholder-gray-400"
                                        placeholder="Cốt truyện như nào? (logic?, sảng văn?, bố cục nhiều lớp?, quay xe liên tục? ...)"/>
                                    <input
                                        data-x-model="world" type="text"
                                        className="px-3 w-full text-sm text-gray-900 border-1 p-2 focus:ring-0 border-gray-600  focus:outline-none dark:text-white placeholder-gray-400"
                                        placeholder="Bố cục thế giới như nào? (lớn hay nhỏ?, một thế giới?, nhiều thế giới?, nhiều tầng? ...)"/><textarea
                                    data-x-model="messages" data-x-data="autoResize" data-x-on:input="resize()"
                                    rows="2"
                                    className="px-3 w-full text-sm text-gray-900 border-1 p-2 focus:ring-0 border-gray-600 focus:outline-none dark:text-white placeholder-gray-400"
                                    placeholder="Nội dung bài đánh giá (ít nhất 100 từ)..." required=""></textarea>
                                </div>
                            </div>
                            <div className="flex justify-center">
                                <button data-x-bind="Submit"
                                        className="inline-flex justify-center px-4 py-2 border shadow-sm text-sm font-medium rounded-md primary-text-color bg-inherit focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600 primary-btn-outline w-1/3"> GỬI
                                    ĐÁNH GIÁ
                                </button>
                            </div>
                        </div>
            ...
            <div>
                <div className={"col-span-4 md:col-span-4 space-y-6 px-2"}>
                    <div className="flex justify-between items-center">
                        <div className="flex items-center"><input data-x-bind="ReviewAll" data-x-model="showAllReviews"
                                                                  type="checkbox"
                        ...
                        <div className="relative inline-block text-left"><select data-x-bind="ReviewSort"
                                                                                 data-x-ref="rvSort" data-x-model="sort"
            ...
            <div>
                <div className="mb-6">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="font-bold">580 thảo luận</div>
                        <div
