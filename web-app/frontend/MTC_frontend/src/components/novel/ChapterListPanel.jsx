...
import LoadingSpining from "../global/LoadingSpining.jsx";
                    ...
                    <a data-x-bind="ChapterItem(index)"
                       ...
                       id="chapter-16845491">
                        <div className="text-sm md:text-base font-medium"
                             data-x-text="chapter.name">Chương 1: Mục tiêu là kia đôi song
                            bào thai!
                        </div>
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center text-xs text-gray-400">
                <span>
                    {new Date(chapter.published_at).toLocaleString("vi-VN")}
                </span>
