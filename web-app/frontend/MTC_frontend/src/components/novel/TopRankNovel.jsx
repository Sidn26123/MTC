    ...
    return (
        <>
            <div className={"w-full rounded-md p-2"}>
                ...
                {/*<NovelCard isBol={1}/>*/}
                {/*<NovelCard/>*/}
                <div data-x-data="realtime" id="real-time"><a href="https://metruyencv.com/thoi-gian-thuc"
                    ...
                    <div data-x-show="isLoading" className="flex justify-center items-center min-h-[490px]"
                         style={{ display: 'none' }}>
                    ...
                    {/*                            data-x-text="item.reading_count"*/}
                    ...
                    {/*                    <div data-x-text="item.reading_count" className="text-gray-500"></div>*/}
                    {/*                </div>*/}
                    {/*            </div>*/}
                    {/*        </template>*/}
                    {/*    </div>*/}
                    ...
                    <div>
                        ...
                        <div className="box-content divide-y divide-dotted divide-auto">
                            ...
                            <div data-x-show="index > 0" className="flex pt-3 px-3" style={{ display: 'none' }}><img
                                ...
                                <div data-x-text="item.reading_count" className="text-gray-500">38</div>
                            </div>
                        </div>
                        {/*Second item*/}
                        <div className="box-content divide-y divide-dotted divide-auto">
                            ...
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                ...
                                <div data-x-text="item.reading_count" className="text-gray-500">25</div>
                            </div>
                        </div>
                            ...
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                ...
                                <a data-x-bind="BookUrl(item.book)" data-x-text="item.book.name" target="_blank"
                                   ...
                                   href="https://metruyencv.com/truyen/vot-thi-nhan" title="Vớt Thi Nhân">Vớt Thi
                                    Nhân</a>
                                <div data-x-text="item.reading_count" className="text-gray-500">24</div>
                            </div>
                        </div>
                        <div className="box-content divide-y divide-dotted divide-auto">
                            <div data-x-show="index === 0" className="flex space-x-2 pt-3 px-3" style={{ display: 'none' }}>
                            ...
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                ...
                                <div data-x-text="item.reading_count" className="text-gray-500">19</div>
                            </div>
                        </div>
                        <div className="box-content divide-y divide-dotted divide-auto">
                            <div data-x-show="index === 0" className="flex space-x-2 pt-3 px-3" style={{ display: 'none' }}>
                                ...
                                <div className="w-full relative"><a data-x-bind="BookUrl(item.book)"
                                                                    data-x-text="item.book.name" target="_blank"
                                                                    className="text-title font-semibold"
                                                                    href="https://metruyencv.com/truyen/van-co-than-de"
                                                                    title="Vạn Cổ Thần Đế">Vạn Cổ Thần Đế</a>
                                    <div className="flex item-center space-x-2 text-primary my-1"><span
                                        data-x-text="item.reading_count"
                                        className="text-sm font-semibold mr-1">17</span> người đang đọc
                                    </div>
                                    <div className="text-gray-500 absolute bottom-0 left-0 space-y-1">
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            ...
                                            <span data-x-bind="BookAuthor(item.book)" className="text-xs truncate">Phi Thiên Ngư</span>
                                        </div>
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                ...
                                <div className="book-cover"><a data-x-bind="BookUrl(item.book)" target="_blank"
                                                               className="book-cover-link"
                                                               href="https://metruyencv.com/truyen/van-co-than-de"
                                                               title="Vạn Cổ Thần Đế"><img
                                    data-x-bind="BookPoster(item.book)"
                                    src="https://static.cdnno.com/poster/van-co-than-de/150.jpg?1585205583"
                                    alt="Vạn Cổ Thần Đế" /></a><span className="book-cover-shadow"></span></div>
                            </div>
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                                                                         className="w-6 h-6"
                                                                                         data-x-bind="RankIcon(index)"
                                                                                         style={{ display: 'none' }} />
                                <div data-x-show="index > 2" data-x-text="index+1"
                                     className="w-6 text-title text-center">5
                                </div>
                                <a data-x-bind="BookUrl(item.book)" data-x-text="item.book.name" target="_blank"
                                   className="w-full text-title truncate mx-2"
                                   href="https://metruyencv.com/truyen/van-co-than-de" title="Vạn Cổ Thần Đế">Vạn Cổ
                                    Thần Đế</a>
                                <div data-x-text="item.reading_count" className="text-gray-500">17</div>
                            </div>
                        </div>
                        <div className="box-content divide-y divide-dotted divide-auto">
                            <div data-x-show="index === 0" className="flex space-x-2 pt-3 px-3" style={{ display: 'none' }}>
                                ...
                                <div className="w-full relative"><a data-x-bind="BookUrl(item.book)"
                                                                    data-x-text="item.book.name" target="_blank"
                                                                    className="text-title font-semibold"
                                                                    href="https://metruyencv.com/truyen/dau-la-ta-hon-ky-co-the-tu-chon"
                                                                    title="Đấu La: Ta Hồn Kỹ Có Thể Tự Chọn">Đấu La: Ta
                                    Hồn Kỹ Có Thể Tự Chọn</a>
                                    <div className="flex item-center space-x-2 text-primary my-1"><span
                                        data-x-text="item.reading_count"
                                        className="text-sm font-semibold mr-1">15</span> người đang đọc
                                    </div>
                                    <div className="text-gray-500 absolute bottom-0 left-0 space-y-1">
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            ...
                                            <span data-x-bind="BookAuthor(item.book)" className="text-xs truncate">Tĩnh Dạ Thính Kinh Lan</span>
                                        </div>
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                            ...
                                            <span data-x-text="item.book.genres[0].name" className="text-xs truncate">Đồng Nhân</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="book-cover"><a data-x-bind="BookUrl(item.book)" target="_blank"
                                                               className="book-cover-link"
                                                               href="https://metruyencv.com/truyen/dau-la-ta-hon-ky-co-the-tu-chon"
                                                               title="Đấu La: Ta Hồn Kỹ Có Thể Tự Chọn"><img
                                    data-x-bind="BookPoster(item.book)"
                                    src="https://static.cdnno.com/poster/dau-la-ta-hon-ky-co-the-tu-chon/150.jpg?1753156111"
                                    alt="Đấu La: Ta Hồn Kỹ Có Thể Tự Chọn" /></a><span
                                    className="book-cover-shadow"></span></div>
                            </div>
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                                                                         className="w-6 h-6"
                                                                                         ...
                                                                                         style={{ display: 'none' }} />
                                <div data-x-show="index > 2" data-x-text="index+1"
                                     className="w-6 text-title text-center">6
                                </div>
                                <a data-x-bind="BookUrl(item.book)" data-x-text="item.book.name" target="_blank"
                                   className="w-full text-title truncate mx-2"
                                   href="https://metruyencv.com/truyen/dau-la-ta-hon-ky-co-the-tu-chon"
                                   title="Đấu La: Ta Hồn Kỹ Có Thể Tự Chọn">Đấu La: Ta Hồn Kỹ Có Thể Tự Chọn</a>
                                <div data-x-text="item.reading_count" className="text-gray-500">15</div>
                            </div>
                        </div>
                        <div className="box-content divide-y divide-dotted divide-auto">
                            <div data-x-show="index === 0" className="flex space-x-2 pt-3 px-3" style={{ display: 'none' }}>
                                ...
                                <div className="w-full relative"><a data-x-bind="BookUrl(item.book)"
                                                                    data-x-text="item.book.name" target="_blank"
                                                                    className="text-title font-semibold"
                                                                    href="https://metruyencv.com/truyen/mu-loa-troc-dao-nhan-bat-dau-max-cap-cuu-duong-than-cong"
                                                                    title="Mù Lòa Tróc Đao Nhân: Bắt Đầu Max Cấp Cửu Dương Thần Công">Mù
                                    Lòa Tróc Đao Nhân: Bắt Đầu Max Cấp Cửu Dương Thần Công</a>
                                    <div className="flex item-center space-x-2 text-primary my-1"><span
                                        data-x-text="item.reading_count"
                                        className="text-sm font-semibold mr-1">14</span> người đang đọc
                                    </div>
                                    <div className="text-gray-500 absolute bottom-0 left-0 space-y-1">
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            ...
                                            <span data-x-bind="BookAuthor(item.book)" className="text-xs truncate">Kim Nhật Vấn Đạo</span>
                                        </div>
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                ...
                                <div className="book-cover"><a data-x-bind="BookUrl(item.book)" target="_blank"
                                                               className="book-cover-link"
                                                               href="https://metruyencv.com/truyen/mu-loa-troc-dao-nhan-bat-dau-max-cap-cuu-duong-than-cong"
                                                               title="Mù Lòa Tróc Đao Nhân: Bắt Đầu Max Cấp Cửu Dương Thần Công"><img
                                    data-x-bind="BookPoster(item.book)"
                                    src="https://static.cdnno.com/poster/mu-loa-troc-dao-nhan-bat-dau-max-cap-cuu-duong-than-cong/150.jpg?1743043985"
                                    alt="Mù Lòa Tróc Đao Nhân: Bắt Đầu Max Cấp Cửu Dương Thần Công" /></a><span
                                    className="book-cover-shadow"></span></div>
                            </div>
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                                                                         className="w-6 h-6"
                                                                                         ...
                                                                                         style={{ display: 'none' }} />
                                <div data-x-show="index > 2" data-x-text="index+1"
                                     className="w-6 text-title text-center">7
                                </div>
                                <a data-x-bind="BookUrl(item.book)" data-x-text="item.book.name" target="_blank"
                                   className="w-full text-title truncate mx-2"
                                   href="https://metruyencv.com/truyen/mu-loa-troc-dao-nhan-bat-dau-max-cap-cuu-duong-than-cong"
                                   title="Mù Lòa Tróc Đao Nhân: Bắt Đầu Max Cấp Cửu Dương Thần Công">Mù Lòa Tróc Đao
                                    Nhân: Bắt Đầu Max Cấp Cửu Dương Thần Công</a>
                                <div data-x-text="item.reading_count" className="text-gray-500">14</div>
                            </div>
                        </div>
                        <div className="box-content divide-y divide-dotted divide-auto">
                            <div data-x-show="index === 0" className="flex space-x-2 pt-3 px-3" style={{ display: 'none' }}>
                                ...
                                <div className="w-full relative"><a data-x-bind="BookUrl(item.book)"
                                                                    data-x-text="item.book.name" target="_blank"
                                                                    className="text-title font-semibold"
                                                                    href="https://metruyencv.com/truyen/no-le-bong-toi"
                                                                    title="Nô Lệ Bóng Tối">Nô Lệ Bóng Tối</a>
                                    <div className="flex item-center space-x-2 text-primary my-1"><span
                                        data-x-text="item.reading_count"
                                        className="text-sm font-semibold mr-1">13</span> người đang đọc
                                    </div>
                                    <div className="text-gray-500 absolute bottom-0 left-0 space-y-1">
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                            ...
                                            <span data-x-bind="BookAuthor(item.book)"
                                                  className="text-xs truncate">Guiltythree</span></div>
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                 aria-hidden="true" data-slot="icon">
                                            ...
                                            <span data-x-text="item.book.genres[0].name" className="text-xs truncate">Kỳ Ảo</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="book-cover"><a data-x-bind="BookUrl(item.book)" target="_blank"
                                                               className="book-cover-link"
                                                               href="https://metruyencv.com/truyen/no-le-bong-toi"
                                                               title="Nô Lệ Bóng Tối"><img
                                    data-x-bind="BookPoster(item.book)"
                                    src="https://static.cdnno.com/poster/no-le-bong-toi/150.jpg?1731995470"
                                    alt="Nô Lệ Bóng Tối" /></a><span className="book-cover-shadow"></span></div>
                            </div>
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                                                                         className="w-6 h-6"
                                                                                         data-x-bind="RankIcon(index)"
                                                                                         style={{ display: 'none' }} />
                                <div data-x-show="index > 2" data-x-text="index+1"
                                     className="w-6 text-title text-center">8
                                </div>
                                <a data-x-bind="BookUrl(item.book)" data-x-text="item.book.name" target="_blank"
                                   className="w-full text-title truncate mx-2"
                                   href="https://metruyencv.com/truyen/no-le-bong-toi" title="Nô Lệ Bóng Tối">Nô Lệ Bóng
                                    Tối</a>
                                <div data-x-text="item.reading_count" className="text-gray-500">13</div>
                            </div>
                        </div>
                        <div className="box-content divide-y divide-dotted divide-auto">
                            <div data-x-show="index === 0" className="flex space-x-2 pt-3 px-3" style={{ display: 'none' }}>
                                ...
                                <div className="w-full relative"><a data-x-bind="BookUrl(item.book)"
                                                                    data-x-text="item.book.name" target="_blank"
                                                                    className="text-title font-semibold"
                                                                    href="https://metruyencv.com/truyen/tran-hoi-truong-sinh"
                                                                    title="Trận Hỏi Trường Sinh">Trận Hỏi Trường
                                    Sinh</a>
                                    <div className="flex item-center space-x-2 text-primary my-1"><span
                                        data-x-text="item.reading_count"
                                        className="text-sm font-semibold mr-1">13</span> người đang đọc
                                    ...
                                    <div className="text-gray-500 absolute bottom-0 left-0 space-y-1">
                                        <div className="flex items-center space-x-1">
                                            ...
                                            <span data-x-bind="BookAuthor(item.book)" className="text-xs truncate">Quan Hư</span>
                                        </div>
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                            ...
                                            <span data-x-text="item.book.genres[0].name" className="text-xs truncate">Tiên Hiệp</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="book-cover"><a data-x-bind="BookUrl(item.book)" target="_blank"
                                                               className="book-cover-link"
                                                               href="https://metruyencv.com/truyen/tran-hoi-truong-sinh"
                                                               title="Trận Hỏi Trường Sinh"><img
                                    data-x-bind="BookPoster(item.book)"
                                    src="https://static.cdnno.com/poster/tran-hoi-truong-sinh/150.jpg?1714986700"
                                    alt="Trận Hỏi Trường Sinh" /></a><span className="book-cover-shadow"></span></div>
                            </div>
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                                                                         className="w-6 h-6"
                                                                                         data-x-bind="RankIcon(index)"
                                                                                         style={{ display: 'none' }} />
                                <div data-x-show="index > 2" data-x-text="index+1"
                                     className="w-6 text-title text-center">9
                                </div>
                                <a data-x-bind="BookUrl(item.book)" data-x-text="item.book.name" target="_blank"
                                   className="w-full text-title truncate mx-2"
                                   href="https://metruyencv.com/truyen/tran-hoi-truong-sinh"
                                   title="Trận Hỏi Trường Sinh">Trận Hỏi Trường Sinh</a>
                                <div data-x-text="item.reading_count" className="text-gray-500">13</div>
                            </div>
                        </div>
                        <div className="box-content divide-y divide-dotted divide-auto">
                            <div data-x-show="index === 0" className="flex space-x-2 pt-3 px-3" style={{ display: 'none' }}>
                                ...
                                <div className="w-full relative"><a data-x-bind="BookUrl(item.book)"
                                                                    data-x-text="item.book.name" target="_blank"
                                                                    className="text-title font-semibold"
                                                                    href="https://metruyencv.com/truyen/ta-co-mot-than-bi-dong-ky"
                                                                    title="Ta Có Một Thân Bị Động Kỹ">Ta Có Một Thân Bị
                                    Động Kỹ</a>
                                    <div className="flex item-center space-x-2 text-primary my-1"><span
                                        data-x-text="item.reading_count"
                                        className="text-sm font-semibold mr-1">13</span> người đang đọc
                                    ...
                                    <div className="text-gray-500 absolute bottom-0 left-0 space-y-1">
                                        <div className="flex items-center space-x-1">
                                            ...
                                            <span data-x-bind="BookAuthor(item.book)" className="text-xs truncate">Ngao Dạ Cật Bình Quả</span>
                                        </div>
                                        <div className="flex items-center space-x-1">
                                            <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                                 viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                ...
                                <div className="book-cover"><a data-x-bind="BookUrl(item.book)" target="_blank"
                                                               className="book-cover-link"
                                                               href="https://metruyencv.com/truyen/ta-co-mot-than-bi-dong-ky"
                                                               title="Ta Có Một Thân Bị Động Kỹ"><img
                                    data-x-bind="BookPoster(item.book)"
                                    src="https://static.cdnno.com/poster/ta-co-mot-than-bi-dong-ky/150.jpg?1738217652"
                                    alt="Ta Có Một Thân Bị Động Kỹ" /></a><span className="book-cover-shadow"></span>
                                </div>
                            </div>
                            <div data-x-show="index > 0" className="flex pt-3 px-3"><img data-x-show="index < 3"
                                                                                         className="w-6 h-6"
                                                                                         ...
                                                                                         style={{ display: 'none' }} />
                                <div data-x-show="index > 2" data-x-text="index+1"
                                     className="w-6 text-title text-center">10
                                </div>
                                <a data-x-bind="BookUrl(item.book)" data-x-text="item.book.name" target="_blank"
                                   className="w-full text-title truncate mx-2"
                                   href="https://metruyencv.com/truyen/ta-co-mot-than-bi-dong-ky"
                                   title="Ta Có Một Thân Bị Động Kỹ">Ta Có Một Thân Bị Động Kỹ</a>
                                <div data-x-text="item.reading_count" className="text-gray-500">13</div>
                            </div>
                        </div>
                    </div>
