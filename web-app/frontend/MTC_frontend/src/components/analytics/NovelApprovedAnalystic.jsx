...
import {
    getNovelApprovedStatistic

} from '../../services/novelStatisticService';
ChartJS.register(CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend);

const NovelApprovedAnalytic = () => {
    ...
    const fetchData = async (value) => {
        ...
        try {
            const result = await getNovelApprovedStatistic(startDate, endDate, segmentType);
    ...
    return (
        ...
        //     <p className="text-gray-600">Số truyện đã được đăng</p>
...
export default NovelApprovedAnalytic;