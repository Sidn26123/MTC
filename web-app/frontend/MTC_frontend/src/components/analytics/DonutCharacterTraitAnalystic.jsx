...
import { getNovelClassificationCharacterTrait } from '../../services/novelStatisticService';

ChartJS.register(ArcElement, Tooltip, Legend);

const DonutCharacterTraitAnalystic = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await getNovelClassificationCharacterTrait();
        ...
        console.error('Lỗi khi tải dữ liệu tính cách nhân vật chính:', error);
      }
    };
  ...
  return (
    <div className="w-[300px] mx-auto relative">
      <h3 className="text-center font-semibold mb-4">Thống kê truyện theo Tính cách nhân vật chính</h3>
...
export default DonutCharacterTraitAnalystic;
