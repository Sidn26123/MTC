...
import { getNovelClassificationSects } from '../../services/novelStatisticService';

ChartJS.register(ArcElement, Tooltip, Legend);

const DonutSectAnalystic = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await getNovelClassificationSects();
        ...
        console.error('Lỗi khi tải dữ liệu sect:', error);
      }
    };
  ...
  return (
    <div className="w-[300px] mx-auto relative">
      <h3 className="text-center font-semibold mb-4">Thống kê truyện theo Lưu phái</h3>
...
export default DonutSectAnalystic;
