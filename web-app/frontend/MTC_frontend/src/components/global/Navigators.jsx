            ...
            <div>
                <div className={"flex flex-row justify-end items-center gap-x-1 w-full"}>
                    ...
                    <div className={"flex flex-row justify-between gap-x-2 items-center"}>
                        ...
                        <span>{data.currentPage*data.pageSize}-{data.currentPage*(data.pageSize + 1) - 1} cua {data.totalElements}</span>
                        <div className={'gap-x-2 flex flex-row text-sm'}>
                            <FontAwesomeIcon icon={faBackwardStep} onClick={goFirst}/>
                            <FontAwesomeIcon icon={faChevronLeft} onClick={goBack}/>
                            <FontAwesomeIcon icon={faChevronRight} onClick={goNext}/>
                            <FontAwesomeIcon icon={faForwardStep} onClick={goLast}/>
                        </div>
                    </div>
                </div>
            </div>
