...
import { reportNovel } from '../../services/feedbackService.js';
...
const UserReport = ({ onClose, targetId, targetType }) => {
    ...
    async function handleReportNovel() {
            ...
            <div className="fixed inset-0 z-10 overflow-y-auto">
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                  ...
                  <textarea
                      ...
                      placeholder="Vui lòng cung cấp thông tin chi tiết về vi phạm của bình luận này"
                      value={description}
                  ...
                  />
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-center">
                                    <button
                                        className="bg-gray text-white rounded-xl w-1/2 text-xl py-2 disabled:opacity-25"
