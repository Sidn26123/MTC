        ...
        <>
            <div>
                <article
                        ...
                        <div className="flex items-center">
                            <p className="inline-flex items-center mr-3 text-sm text-gray-200">
                                <img
                                    ...
                                    alt="Dương Khai"
                                />
                                <a className="font-bold text-title select-text" href="/ho-so/1004984">Dương Khai</a>
                            </p>
                    ...
                    <p className="text-gray-300 line-clamp break-words select-text" id="cmContent4329074">1 vợ chung
                        tình</p>
