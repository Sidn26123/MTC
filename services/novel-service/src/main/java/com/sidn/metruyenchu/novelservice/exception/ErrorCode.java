...
public enum ErrorCode {
    ...
    BOOKSHELF_NOT_FOUND(10007, "Thư viện không tồn tại", HttpStatus.NOT_FOUND),
    BOOKSHELF_ITEM_ALREADY_DELETED(10008, "Mục trong thư viện đã bị xóa", HttpStatus.BAD_REQUEST),
...
//    RATE_LIMIT_EXCEEDED(1201, "Bạn đã gửi quá nhiều yêu cầu. Vui lòng thử lại sau", HttpStatus.TOO_MANY_REQUESTS);
    ...
    CHAPTER_STATUS_NOT_FOUND(1010, "Trạng thái chương không tồn tại", HttpStatus.NOT_FOUND);
