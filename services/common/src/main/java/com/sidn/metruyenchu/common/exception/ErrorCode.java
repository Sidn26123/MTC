...
public enum ErrorCode {
    ...
    FILE_UPDATE_FAILED(7006, "Cập nhật tệp thất bại", HttpStatus.INTERNAL_SERVER_ERROR),
    ...
    PROFILE_NOT_FOUND(3001, "Hồ sơ không tồn tại", HttpStatus.NOT_FOUND),
    PROFILE_ALREADY_EXISTS(3002, "Hồ sơ đã tồn tại", HttpStatus.BAD_REQUEST),
    INVALID_PROFILE_STATUS(3003, "Trạng thái hồ sơ không hợp lệ", HttpStatus.BAD_REQUEST),
