package com.sidn.metruyenchu.user_service.exception;
...
public enum ErrorCode {
    ...
    FOLDER_ALREADY_EXISTS(7006, "Thư mục đã tồn tại", HttpStatus.BAD_REQUEST),
    FOLDER_NOT_FOUND(7007, "Thư mục không tồn tại", HttpStatus.NOT_FOUND),
    INVALID_FOLDER_NAME(7008, "Tên thư mục không hợp lệ", HttpStatus.BAD_REQUEST),
    INVALID_FOLDER_PATH(7009, "Đường dẫn thư mục không hợp lệ", HttpStatus.BAD_REQUEST),
    ...
    PROFILE_NOT_FOUND(7013, "Hồ sơ không tồn tại", HttpStatus.NOT_FOUND),
